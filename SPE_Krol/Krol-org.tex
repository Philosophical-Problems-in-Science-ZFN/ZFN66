...
%\usepackage[cp1250]{inputenc} %dostosowa+++nie kodowania czcionki do windowsa
...
\newcommand{\roha}{\mbox{${\rho_H}$}}
\newcommand {\cA}{\mbox{${\mathcal A}$}}
\newcommand {\ccA}{\mbox{$\mathtilde{\cal A}$}}
\newcommand {\cE}{\mbox{${\mathcal E}$}}
\newcommand {\cH}{\mbox{${\mathcal H}_x$}}
\newcommand {\cHH}{\mbox{${\mathcal H}$}}
...
\newcommand{\Sig}{\mbox{$\underline{\Sigma }$}}
\newcommand{\Sub}{\mbox{$\underline{S}$}}
\newcommand{\Subcl}{\mbox{$\mathrm{Sub}_{cl}\Sig $}}
\newcommand {\RR}{\mbox{${\mathbf{R} }$}}
\newcommand {\CC}{\mbox{${\mathbf{C} }$}}
\newcommand {\ev}{\mbox{${{\mathrm{ev}}$}}}
\newcommand {\cross}{\mbox{${\times \! \! \! \!\times}$}}
\newcommand{\pr }{\mbox{${\mathrm{pr}}$}}
\newcommand {\id}{\mbox{${\mathrm{id}}$}}
\newcommand {\HH}{\mbox{${\hat{H}}$}}
\newcommand {\D}{\mbox{${\Delta \! \! \! \! \Delta }$}}
...
%ul. 75 Pu{\l}ku Piechoty 1, 41-500 Chorz{\'o}w, Poland
%\\
\and 
...
\bibitem{Woodard2014} R. P. Woodard, 2014. Perturbative quantum gravity comes of age, \emph{International Journal of Modern Physics} D, 23(9), pp. 1430020.
\bibitem{Neutrino-mass-KmLAND-Zen2016}
...
\bibitem{AK2018} T. Asselmeyer-Maluga, J. Kr{\'o}l, 2018. How to obtain a cosmological constant from small exotic $\mathbb{R}^4$, {\em Physics of the Dark Universe} 19, pp. 66-77. 
\bibitem{AK2014} T. Asselmeyer-Maluga, J. Kr{\'o}l, 2014. Inflation and topological phase transition driven by exotic smoothness, \emph{Advances in High Energy Physics} 2014, Article ID 867460, 14 pages.
\bibitem{AK2019} T. Asselmeyer-Maluga, J. Kr{\'o}l, 2019. A topological approach to neutrino masses by using exotic smoothness, \emph{Modern Physics Letters} 33(1) pp. 1950097-1 (14 pages).
\bibitem{GS1999} R. Gompf, A. Stipsicz, 1999. \emph{4-Manifolds and Kirby Calculus}, USA: AMS. 
\bibitem{JKuniverse17} J. Kr{\'o}l, T. Asselmeyer-Maluga, K. Bielas, P. Klimasara, 2017. From quantum to cosmological regime. The role of forcing  and exotic 4-smoothness, {\em Universe}, 3(2), 31.
\bibitem{JK2017a} J. Kr\'ol, P. Klimasara, K. Bielas, T.  Asselmeyer-Maluga, 2017. Dimension 4: Quantum origins of spacetime smoothness, \emph{Acta Physica Polonica} B 48(12) pp. 2375-2380.
\bibitem{Freedman1979}  M. H. Freedman, 1979. A fake $S^3\times \mathbb{R}$, {\em Annales of Mathematics},
110 pp. 177-201.
\bibitem{Kappos1969} D. A. Kappos, 1969. \emph{Probability, Algebras and Stochastic Spaces}, New York: Academic.
\bibitem{Jech2003} T. Jech, 2003. \emph{Set Theory}, The Third Millenium Edition, Springer Monographs in Mathematics, Berlin, Heildelberg: Springer.
\bibitem{Bell2005} J. L. Bell, 2005. \emph{Set Theory. Boolean-valued Models and Independence Proofs.} 3rd ed. Oxford Logic Guides: 47, Oxford: Clarendon Press.
\bibitem{Boos1996} W. Boos, 1996. Mathematical quantum theory I: Random ultrafilters as hidden variables, \emph{Synthese}, 107 pp. 83-143.
\bibitem{Solovay1970} R. M. Solovay, 1970. A Model of set theory in which every set of reals is Lebesgue measurable, \emph{Annales of Mathematics}, 92(1) pp. 1-56.
\bibitem{Jech1986} T. Jech, 1986. \emph{Multiple Forcing.} Cambridge Tracts in Mathematics, No. 88, Cambridge, UK: Cambridge U.P.
