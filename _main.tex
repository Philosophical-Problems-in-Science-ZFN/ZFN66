...
\AtEveryBibitem{\clearfield{titleaddon}\clearfield{month}\clearfield{note}\clearlist{language}}
...
\input{EDI_Heller/40latZFN.tex}



\sekcja{Emergence of the Classical}{Emergence of the Classical}

\input{SPE_Krol/Krol.tex}

\input{SPE_Lizzi/Lizzi.tex}

\input{SPE_Fredenhagen/Fredenhagen.tex}

\input{SPE_Arodz/Arodz.tex}

\input{SPE_Dembinski/Dembinski.tex}
...
\input{ART_Kiefer/Kiefer.tex}

\input{ART_Sierotowicz/Sierotowicz.tex}

\input{ART_Liana/Liana.tex}
...
\input{CLA_Heller/Heller.tex}

\input{CLA_Polak/Polak.tex}

\input{CLA_Trombik/Trombik.tex}



\sekcja{Recenzje}{Book reviews}

\input{REC_Polak1/Polak.tex}

\input{REC_Polak2/Polak.tex}

\input{REC_Rodzen/Rodzen.tex}

\input{REC_Trombik/Trombik.tex}

\input{REC_Petreshak/Petreshak.tex}

\input{REC_Slezinski/Slezinski.tex}
