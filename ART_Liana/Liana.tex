\begin{artplenv}{Zbigniew Liana}
	...
	{Philosophical interests of Joseph Życiński (1948-2011) in the domain of the philosophy of science were focused on the
		...
		with a~new concept of the doxatic rationality. However, the details of the metascientific proposal of Życiński will be given
...
jest to szeroko rozumiana racjonalistyczna tradycja \textit{episteme}
\parencite[por.][s.~126]{zycinski_elementy_2015}
%( \textit{Elementy}, )
w~jej
...
założeniem filozofii nauki. Życiński uznaje ten fakt za skutek rewolucji metanaukowej
...
Życiński przytacza sceptyczną uwagę J. Watkinsa odnośnie do tego typu rozróżnień u~Poppera i~Lakatosa, ale nie wydaje na
...
Przykładem takiej metanaukowej reakcji jest bez wątpienia wspomniana reakcja Bohra na doświadczenie paradoksalności
...
tych ostatnich ich istotną rolę w~rozwoju nauki\footnote{Od samego początku Życiński wiąże obecność czynników
...
użycia mogą być dzisiaj wyłącznie względy sentymentalne
...
Życiński mówi o~emocjonalnych reakcjach na Gödlowskie twierdzenie o~możliwej
