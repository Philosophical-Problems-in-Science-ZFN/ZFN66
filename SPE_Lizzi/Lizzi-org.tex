...
%\usepackage{color}
%% the following defines more colors available at http://en.wikibooks.org/wiki/LaTeX/Colors#Entering_colored_background_for_the_text
...
\usepackage[pdfstartview=FitH,colorlinks=true,linkcolor=black,anchorcolor=black,citecolor=black,urlcolor=black]{hyperref}
\usepackage[english]{babel}
%\usepackage[top=2.5cm,right=2.7cm,left=2.7cm,bottom=2.7cm]{geometry}
\usepackage{amsmath,amssymb,titling,authblk}
\usepackage{slashed}
\usepackage{amsmath}
\usepackage{amscd}
...
%\usepackage[utf8]{inputenc}
%\usepackage{authblk}
%\usepackage{amsmath,amssymb,epsfig,cite,dsfont,titling}
...
\textwidth6.2in
\textheight8.5in
\advance\hoffset by -1.1truecm
\advance\voffset by -1.0truecm
...
\usepackage{float}
\restylefloat{figure}
%those command define the appendix with correct numbering in report style
\newcounter{appendice}
\newcommand{\appendice}
{ \setcounter{equation}{0}
\renewcommand{\theequation}{\Alph{appendice}.\arabic{equation}}
\addtocounter{appendice}{1} {\bf \Large Appendix \Alph{appendice}}
}
...
%\pretitle{\begin{flushright}\small
%ICCUB-\ldots
%\end{flushright}\vspace*{2pc}%
%\begin{center}\LARGE}
...
\affil[1]{Dipartimento di Fisica ``Ettore Pancini'', Universit\`{a} di Napoli {\sl Federico~II}, Napoli, Italy}
\affil[2]{INFN, Sezione di Napoli, Italy}
\affil[3]{Departament de F\'{\i}sica Qu\`antica i Astrof\'{\i}sica and Institut de C\'{\i}encies del Cosmos (ICCUB),
...
1983). 
 ...
 \bibitem{Messiah} A.~Messiah, \textit{Quantum Mechanics, I}, North Holland, 1961.
 
 \bibitem{Perelomov} A. Perelomov, \textit{Generalized Coherent States and
Their Applications},  Springer, 1986.
 
 \bibitem{Connesbook} A.\ Connes, \textit{Noncommutative Geometry}, Academic Press, 1994.

\bibitem{HeisenbergtoPeirleis} W. Pauli, Letter of Heisenberg to Peirels (1930), in Wolfgang Pauli, Scientific Correspondence, Vol. II,Springer Verlag, 1985, 15.
...
\bibitem{DFR} S.~Doplicher, K.~Fredenhagen and J.~E.~Roberts,
...
\bibitem{WSS} P.~Aschieri, M.~Dimitrijevich, P. Kulish, F.~Lizzi, J.~Wess, \textit{Noncommutative Spacetimes}, Springer Lecture Notes 774, 2009.

\bibitem{Gerstenhaber} M.\ Gerstenhaber, ``On the deformation of rings and algebras'', Ann.\ Math.\ 79,59(1964) 105.

\bibitem{starprod} F. Bayen, M. Flato, C. Fronsdal, A. Lichnerowicz and D. Sternheimer, ``Deformation theory
and quantization'', Ann.\ Phys.\ 111, 61 (1978). 5.

\bibitem{Gronewold} H.~J.~Groenewold,
...
\bibitem{FrohlichGawedski} J.~Frohlich and K.~Gawedzki,
...
\bibitem{GalluccioLizziVitale1} S.~Galluccio, F.~Lizzi and P.~Vitale,
  ...
  %%CITATION = doi:10.1088/1126-6708/2009/09/054;%%
  %27 citations counted in INSPIRE as of 24 Mar 2019

\bibitem{GalluccioLizziVitale2}
...
\bibitem{Huggett} N.\ Huggett, ``A Philosopher Looks at Non-Commutative Geometry''.  2018  [Preprint]     URL: http://philsci-archive.pitt.edu/id/eprint/15432.

\bibitem{Weinberg} S.\ Weinberg, \textit{Quantum Theory of Fields I-III}, Cambridge University press, 1995.

\bibitem{LizziVitaleReview} F.~Lizzi and P.~Vitale,
...
\bibitem{Walterbook} W. Van Suijlekom \textit{Noncommutative Geometry and Particle Physics} Springer 2015.
...
%\cite{Andrianov:1983qj}
\bibitem{AndrianovBonora2}
  A.~A.~Andrianov and L.~Bonora,
...
\bibitem{Fujikawabook} K.~Fujikawa, H.~Suzuki, {\it Path
    Integrals And Quantum Anomalies}, Oxford university Press, 2004.


%\cite{Andrianov:2010nr}
\bibitem{Andrianov:2010nr}
  ...
  %%CITATION = ARXIV:1001.2036;%%
  %12 citations counted in INSPIRE as of 28 Nov 2013

%\cite{Andrianov:2011bc}
\bibitem{Andrianov:2011bc}
  ...
  %%CITATION = ARXIV:1106.3263;%%
  %10 citations counted in INSPIRE as of 28 Nov 2013
  
 %\cite{Kurkov:2012dn}
\bibitem{Kurkov:2012dn}
  M.~A.~Kurkov and F.~Lizzi,
  ``Higgs-Dilaton Lagrangian from Spectral Regularization,''
  Mod.\ Phys.\ Lett.\ A {\bf 27} (2012) 1250203
  [arXiv:1210.2663 [hep-th]].
  %%CITATION = ARXIV:1210.2663;%%
  %4 citations counted in INSPIRE as of 28 Nov 2013 
...
\bibitem{Sakharov} A.~D.~Sakharov,
  ...
  %%CITATION = GRGVA,32,365;%%


%\cite{Kurkov:2013gma}
\bibitem{Kurkov:2013gma}
  M.~A.~Kurkov and M.~Sakellariadou,
  ``Spectral Regularisation: Induced Gravity and the Onset of Inflation,''
  arXiv:1311.6979 [hep-th].
  %%CITATION = ARXIV:1311.6979;%%  


\bibitem{zeta}   M.~A.~Kurkov, F.~Lizzi, M.~Sakellariadou and A.~Watcharangkool,
...
S.~Carlip,
  ...
  %%CITATION = doi:10.3390/universe5030083;%%
...
G.~Amelino-Camelia, L.~Freidel, J.~Kowalski-Glikman and L.~Smolin,
  ...
  %%CITATION = doi:10.1103/PhysRevD.84.084010;%%
...
F.~Lizzi, M.~Manfredonia, F.~Mercati and T.~Poulain,
  ...
  %%CITATION = doi:10.1103/PhysRevD.99.085003;%%
